            ...
            <div>
                <div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
                    <div class="w3-content">
                        <div class="w3-third w3-center">
                            <i class="fa fa-stiker_6.jfif w3-padding-64 w3-text-red w3-margin-right"><Image1 image="stiker_6.jfif">
                            </Image1></i>
                        </div>
                ...
                <div class="w3-row-padding w3-padding-64 w3-container">
                    <div class="w3-content">
                        ...
                        <div class="w3-third w3-center">
                            <i class="fa fa-stiker_7.jfif w3-padding-64 w3-text-red"><Image1 image="stiker_7.jfif">
                            </Image1></i>
                        </div>
                    </div>
                </div>
